...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Gracias por registrarse en INDARCA. Para completar la verificación de su correo electrónico, utilice el siguiente código:</p>

            <div class="verification-code">
                {{ $codigo }}
            </div>

            <p>Este código expirará en <strong>15 minutos</strong>. Si no ha solicitado este código, puede ignorar este mensaje.</p>

            <div class="info">
                <strong>Importante:</strong> No comparta este código con nadie. El equipo de INDARCA nunca le pedirá su código de verificación por teléfono o correo electrónico.
            </div>

            <div class="highlight-box">
                <p style="margin-top: 0;">Si tiene alguna pregunta o encuentra algún problema durante el proceso de verificación, nuestro equipo de soporte está disponible para asistirle.</p>
            </div>
        </div>
