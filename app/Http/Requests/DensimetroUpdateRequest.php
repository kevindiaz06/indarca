...
class DensimetroUpdateRequest extends FormRequest
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'fecha_proxima_calibracion.required_if' => 'La fecha de próxima calibración es obligatoria cuando el densímetro está calibrado.',
            'fecha_proxima_calibracion.date' => 'La fecha de próxima calibración debe ser una fecha válida.',
        ];
    }
}
